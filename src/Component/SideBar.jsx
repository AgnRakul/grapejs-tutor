...
const SideBar = ({ editor }) => {
                ...
                return block.SubCategory.map((subCategory, index) => {
                    return (
                        <div
                            ...
                            className={`subcat ${selectedSubBlock === subCategory.id && "selected"
                                }`}
                        >
                            {subCategory.label}
                        </div>
    ...
    return (
        <div className="sidebar icons" id="panels-container">
            <BiMessageSquareAdd style={{ width: "20px", height: "40px", cursor: "pointer", marginTop: "30px", }}
                        ...
                        {blocks.map((item, index) => {
                            return (
                                <div
                                    ...
                                    className={`category ${selectedBlock === item.Category && "selected"
                                        }`}
                                >
                                    {item.Category}
                                </div>
