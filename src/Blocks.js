        ...
        modal: [
          {
            ...
            content: `<style>
                .freedownloads-popup-sec {  left: 30%; top: 200px; background-color: #8e8e41; font-family: 'Roboto Slab', serif; width: 700px;  padding: 45px 65px 65px 65px;  -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; box-sizing: border-box; position: relative; -webkit-box-shadow: 0px 10px 20px 0px rgba(50, 50, 50, 0.52);-moz-box-shadow: 0px 10px 20px 0px rgba(50, 50, 50, 0.52);box-shadow: 0px 10px 20px 0px rgba(50, 50, 50, 0.52); }
