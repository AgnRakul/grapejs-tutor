export const Blocks = [
    {
        ...
        content: `<style>
        .freedownloads-popup-sec { background-color: #8e8e41; font-family: 'Roboto Slab', serif; width: 700px; margin: 30px auto; padding: 45px 65px 65px 65px;  -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; box-sizing: border-box; position: relative;-webkit-box-shadow: 0px 10px 20px 0px rgba(50, 50, 50, 0.52);-moz-box-shadow: 0px 10px 20px 0px rgba(50, 50, 50, 0.52);box-shadow: 0px 10px 20px 0px rgba(50, 50, 50, 0.52); }
    ...
    {
        id:"block-Input",
        label: `<b><img src="https://img.icons8.com/windows/32/000000/text-input-form.png"/></b>`,
        content: `<input type="text" value="Rene Leeuwenstein" 
        style="border:5px solid teal;background-color:#eafafb;">`,
        category: "Basic",
        attributes: {
            title: "Basic Inputs"
        }
    ...
    {
        id:"block-Button",
        label: `<b><img src="https://img.icons8.com/ios-filled/50/000000/button2.png"/></b>`,
        content: `<button style="background-color: turquoise; border: none; border-radius: 5px; color: #333; /* Dark grey */ padding: 15px 32px">Example button</button>`,
        category: "Basic",
        attributes: {
            title: "Basic Button"
        }
